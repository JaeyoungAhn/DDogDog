...
public class ReservationFacade {
  ...
  public OrderedReservationResult order(Long userId,
    ...
    Long reservationId = reservationService.create(userId, roomId, roomInfo,
  ...
  private void validateStay(Long roomId, StayPeriod stayPeriod) {
    if (!reservationService.isRoomAvailableOnDate(roomId, stayPeriod.checkIn(), stayPeriod.checkOut())) {
