...
class ReviewTest {
    ...
    void createReviewEntity_SuccessOnValid() {
        ...
        assertThat(review.getEmail().getValue()).isEqualTo("test@ddog.dog");
    }
    ...
    void createReviewEntity_FailOnEmptyReview() {
        ...
        Exception exception = catchException(
                () -> new Review(1L, 1L, new Content(""), new RatingScore(2.5), new Email("test@ddog.dog")));
    ...
    void createReviewEntity_FailOnInvalidLength() {
        // Given & When
        Exception exception = catchException(
                () -> new Review(1L, 1L, new Content("좋았다."), new RatingScore(2.5), new Email("test@ddog.dog")));
